...
<form action="{{route('todo.store')}}" method="post" class="py-5">
    @csrf
    <input class="py-2 px-2 border rounded-lg outline-none" type="text" name='title' placeholder="Title">
    <textarea name="description" cols="23" rows="6" class="p-2 rounded border block mx-auto my-2 outline-none" placeholder="Description"></textarea>
